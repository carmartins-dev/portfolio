...
<b>Tech & dev tools:</b> C#, Unity, Aseprite, Visual Studio, Audacity

With this project I was aiming at creating a fully fledged story-driven game with well thought-out gameplay mechanics. I focused on building modular gameplay systems that could scale into a full production-ready architecture. I developed robust cutscene management and conversation logic as well as exploration and combat systems.<br>
...
<b>Tech & dev tools:</b> HTML, CSS, JavaScript, PHP, MySQL, REST APIs, Advanced Encryption Standard (AES), C#, Unity, Aseprite, Visual Studio, Audacity
